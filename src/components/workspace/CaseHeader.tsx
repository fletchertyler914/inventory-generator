...
export const CaseHeader = memo(
  ...
  (prevProps, nextProps) => {
    ...
    return (
      ...
      prevProps.viewingFile?.id === nextProps.viewingFile?.id &&
      prevProps.reportMode === nextProps.reportMode &&
      prevProps.notesVisible === nextProps.notesVisible &&
      prevProps.findingsVisible === nextProps.findingsVisible &&
      prevProps.timelineVisible === nextProps.timelineVisible &&
      prevProps.isSyncing === nextProps.isSyncing &&
      prevProps.autoSyncEnabled === nextProps.autoSyncEnabled &&
      prevProps.onClose === nextProps.onClose &&
      prevProps.onAddFiles === nextProps.onAddFiles &&
      prevProps.onAddFolders === nextProps.onAddFolders &&
      prevProps.onToggleReportMode === nextProps.onToggleReportMode &&
      prevProps.onToggleNotes === nextProps.onToggleNotes &&
      prevProps.onToggleFindings === nextProps.onToggleFindings &&
      prevProps.onToggleTimeline === nextProps.onToggleTimeline &&
      ...
      prevProps.onSyncFiles === nextProps.onSyncFiles &&
      prevProps.onToggleAutoSync === nextProps.onToggleAutoSync
    )
  }
)
